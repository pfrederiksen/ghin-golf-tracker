...
**Note on Data Collection**: GHIN data collection is performed separately by the OpenClaw agent using browser automation tools. This skill only processes the already-collected data file.
